...
export async function addItemToCart(data: CartItem) {
  try {
    ...
    // you could be guest user or authenticated , so check cookies, should exist for both
    ...
    if (!cart) {
      ...
      // revalidate the product page, to keep everything up-to-date
      revalidatePath(`/product/${product.slug}`);
...
export async function getMyCart() {
  ...
  // convert prisma obj into plain obj using convertToPlainObject
  // Convert Decimal values to strings , to prevent future TypeScript errors
